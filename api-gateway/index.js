...
app.use((req, res, next) => {
  ...
  res.on('finish', () => {
    ...
    let service = 'unknown';
    if (req.originalUrl.startsWith('/products')) service = 'product-service';
...
app.get('/health', async (req, res) => {
  ...
  try {
    // You could add backend service health checks here
...
app.get('/dashboard', async (req, res) => {
  try {
    ...
    // In a real implementation,  make requests to multiple services
    res.json({
      success: true,
